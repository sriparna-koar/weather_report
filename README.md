Home Page by addding the cities name we can view the weather report and as per the temperture we can view the symbol it will give the current weather on every refresh
